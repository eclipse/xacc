...
//   U1 u1(0, 3.14);
//   EXPECT_TRUE(boost::get<double>(u1.getParameter(0)) == 3.14);
...
//   EXPECT_TRUE(boost::get<double>(u12.getParameter(0)) == 1.71234);
...
//   U2 u2(0, 3.14, 1.57);
//   EXPECT_TRUE(boost::get<double>(u2.getParameter(0)) == 3.14);
//   EXPECT_TRUE(boost::get<double>(u2.getParameter(1)) == 1.57);
...
//   EXPECT_TRUE(boost::get<double>(u22.getParameter(0)) == 1.71234);
//   EXPECT_TRUE(boost::get<double>(u22.getParameter(1)) == .22);
...
//   EXPECT_TRUE(u22.name() == "U2");
  ...
  U u(0, 3.14, 1.57, .33);
  EXPECT_TRUE(boost::get<double>(u.getParameter(0)) == 3.14);
  EXPECT_TRUE(boost::get<double>(u.getParameter(1)) == 1.57);
  EXPECT_TRUE(boost::get<double>(u.getParameter(2)) == .33);
  ...
  EXPECT_TRUE(boost::get<double>(u222.getParameter(0)) == 1.71234);
  EXPECT_TRUE(boost::get<double>(u222.getParameter(1)) == .22);
  EXPECT_TRUE(boost::get<double>(u222.getParameter(2)) == .44);
