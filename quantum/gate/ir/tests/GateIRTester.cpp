...
TEST(GateIRTester, checkCreationToString) {
  const std::string expectedQasm = "qubit qreg0\n"
                                   "qubit qreg1\n"
                                   "qubit qreg2\n"
                                   "H qreg1\n"
                                   "CNOT qreg1,qreg2\n"
...
Qubits=[0],Enabled=1\"];\n" "2 [label=\"Gate=h,Circuit Layer=1,Gate Vertex
Id=2,Gate Acting Qubits=[1],Enabled=1\"];\n" "3 [label=\"Gate=cnot,Circuit
Layer=2,Gate Vertex Id=3,Gate Acting Qubits=[1 2],Enabled=1\"];\n" "4
...
Acting Qubits=[0],Enabled=1\"];\n" "6 [label=\"Gate=measure,Circuit Layer=5,Gate
Vertex Id=6,Gate Acting Qubits=[0],Enabled=1\"];\n" "7
[label=\"Gate=measure,Circuit Layer=5,Gate Vertex Id=7,Gate Acting
Qubits=[1],Enabled=1\"];\n" "8 [label=\"Gate=FinalState,Circuit Layer=6,Gate
Vertex Id=8,Gate Acting Qubits=[0 1 2],Enabled=1\"];\n" "9
...
Qubits=[2],Enabled=0\"];\n" "12 [label=\"Gate=FinalState,Circuit Layer=9,Gate
Vertex Id=12,Gate Acting Qubits=[0 1 2],Enabled=0\"];\n" "13
...
TEST(GateIRTester,checkGenerateGraph) {
    ...
    f->addInstruction(rz);
        ...
        std::string expected = "graph G {\n"
                        "node [shape=box style=filled]\n"
                        "0 [label=\"Gate=InitialState,Circuit Layer=0,Gate
Vertex Id=0,Gate Acting Qubits=[0 1 2],Enabled=1,RuntimeParameters=[]\"];\n" "1
[label=\"Gate=h,Circuit Layer=1,Gate Vertex Id=1,Gate Acting
Qubits=[1],Enabled=1,RuntimeParameters=[]\"];\n" "2 [label=\"Gate=cnot,Circuit
Layer=2,Gate Vertex Id=2,Gate Acting Qubits=[1
2],Enabled=1,RuntimeParameters=[]\"];\n" "3 [label=\"Gate=cnot,Circuit
Layer=3,Gate Vertex Id=3,Gate Acting Qubits=[0
1],Enabled=1,RuntimeParameters=[]\"];\n" "4 [label=\"Gate=h,Circuit Layer=4,Gate
Vertex Id=4,Gate Acting Qubits=[0],Enabled=1,RuntimeParameters=[]\"];\n" "5
[label=\"Gate=FinalState,Circuit Layer=5,Gate Vertex Id=5,Gate Acting Qubits=[0
1 2],Enabled=1,RuntimeParameters=[]\"];\n" "0--1 [label=\"weight=0.000000\"];\n"
