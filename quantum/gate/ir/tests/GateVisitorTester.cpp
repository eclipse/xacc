...
class TestVisitor : public BaseInstructionVisitor, // ALWAYS REQUIRED
                    public InstructionVisitor<CNOT>,
                    public InstructionVisitor<Hadamard> {
public:
  virtual void visit(CNOT &cnot) { std::cout << "HELLO WORLD CNOT\n"; }

  virtual void visit(Hadamard &h) { std::cout << "HELLO WORLD HADAMARD\n"; }
};
