...
namespace ibm_pulse {
    ...
    class PulseLibrary {
        ...
        public:
        const std::vector<std::vector<double>> & get_samples() const { return samples; }
        std::vector<std::vector<double>> & get_mutable_samples() { return samples; }
        void set_samples(const std::vector<std::vector<double>> & value) { this->samples = value; }
    ...
    class Config {
        ...
        void set_meas_lo_freq(const std::vector<double> & value) { this->meas_lo_freq = value; }

        const std::vector<PulseLibrary> & get_pulse_library() const { return pulse_library; }
        std::vector<PulseLibrary> & get_mutable_pulse_library() { return pulse_library; }
        void set_pulse_library(const std::vector<PulseLibrary> & value) { this->pulse_library = value; }
        ...
        void set_qubit_lo_freq(const std::vector<double> & value) { this->qubit_lo_freq = value; }
        ...
        void set_memory_slot_size(const int64_t & value) { this->memory_slot_size = value; }
    ...
    class Instruction {
        ...
        void set_memory_slot(std::vector<int64_t> value) { this->memory_slot = value; }
    ...
    class Experiment {
        ...
        void set_instructions(const std::vector<Instruction> & value) { this->instructions = value; }
    ...
    class QObject {
        ...
        void set_experiments(const std::vector<Experiment> & value) { this->experiments = value; }
...
namespace nlohmann {
    ...
    inline void from_json(const json & j, xacc::ibm_pulse::Config& x) {
        ...
        x.set_pulse_library(j.at("pulse_library").get<std::vector<xacc::ibm_pulse::PulseLibrary>>());
    ...
    inline void from_json(const json & j, xacc::ibm_pulse::Instruction& x) {
        ...
        x.set_memory_slot(xacc::ibm_pulse::get_optional<std::vector<int64_t>>(j, "memory_slot"));
        x.set_duration(xacc::ibm_pulse::get_optional<int64_t>(j, "duration"));
        x.set_qubits(xacc::ibm_pulse::get_optional<std::vector<int64_t>>(j, "qubits"));
    }
    ...
    inline void from_json(const json & j, xacc::ibm_pulse::Experiment& x) {
        x.set_instructions(j.at("instructions").get<std::vector<xacc::ibm_pulse::Instruction>>());
    ...
    inline void from_json(const json & j, xacc::ibm_pulse::QObject& x) {
        ...
        x.set_experiments(j.at("experiments").get<std::vector<xacc::ibm_pulse::Experiment>>());
