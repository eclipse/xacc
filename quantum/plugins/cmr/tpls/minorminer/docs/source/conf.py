# -*- coding: utf-8 -*-
#
# minorminer documentation build configuration file, created by
...
# Pat to the breathe module itself
# sys.path.append()
...
htmlhelp_basename = 'minorminerdoc'
...
latex_documents = [
    (master_doc, 'minorminer.tex', u'minorminer Documentation',
     u'D-Wave Systems', 'manual'),
]
...
man_pages = [
    (master_doc, 'minorminer', u'minorminer Documentation',
     [author], 1)
]
