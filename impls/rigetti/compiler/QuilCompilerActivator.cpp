 ...
 */
class US_ABI_LOCAL QuilCompilerActivator : public BundleActivator
{


public:

	QuilCompilerActivator() {}
...
CPPMICROSERVICES_EXPORT_BUNDLE_ACTIVATOR(QuilCompilerActivator)
//![Activator]
