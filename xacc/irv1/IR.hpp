...
public:
   ...
   *
   * @param kernel The CompositeInstruction instance to add as a new kernel
   */
  virtual void addKernel(std::shared_ptr<CompositeInstruction> kernel) = 0;
   ...
   */
  virtual std::shared_ptr<CompositeInstruction> getKernel(const std::string &name) = 0;
   ...
   */
  virtual std::vector<std::shared_ptr<CompositeInstruction>> getKernels() = 0;
