...
namespace xacc {
class AcceleratorBufferPostprocessor : public Identifiable,
                                       public OptionsProvider {
public:
  virtual std::vector<std::shared_ptr<AcceleratorBuffer>>
  process(std::vector<std::shared_ptr<AcceleratorBuffer>> buffers) = 0;
  virtual ~AcceleratorBufferPostprocessor() {}
};

class NullAcceleratorBufferPostprocessor
...
public:
   ...
   */
  virtual const std::string name() const { return "null-postprocessor"; }
