...
The role of the \hyperlink{a00021}{C\+L\+I\+Parser} is to parse all command line options provided to an X\+A\+C\+C-\/enabled program. It takes upon construction to available argc and argv variables from the command line, and parses them to fill the \hyperlink{a00073}{Runtime\+Options} singleton and load any X\+A\+CC \hyperlink{a00023}{Compiler} or \hyperlink{a00011}{Accelerator} plugins.
