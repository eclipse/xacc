\hypertarget{a00030}{}\section{xacc\+:\+:Accelerator Class Reference}
\label{a00030}\index{xacc\+::\+Accelerator@{xacc\+::\+Accelerator}}
...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{a00030_ac3e781f42ec25e460174d4c41ea26b94}{store\+Buffer} (const std\+::string \&id, std\+::shared\+\_\+ptr$<$ \hyperlink{a00032}{Accelerator\+Buffer} $>$ b)
\end{DoxyCompactItemize}


\subsection{Detailed Description}
The \hyperlink{a00030}{Accelerator} class provides a high-\/level abstraction for X\+A\+CC\textquotesingle{}s interaction with attached post-\/exascale accelerators (quantum and neuromorphic processing units).

Derived Accelerators must provide a valid execute implementation that takes X\+A\+CC \hyperlink{a00167}{IR} and executes it on the attached hardware or simulator.

Derived Accelerators must provide a list of \hyperlink{a00168}{I\+R\+Transformation} instances that transform X\+A\+CC \hyperlink{a00167}{IR} to be amenable to execution on the hardware.

Derived Accelerators must provide implementations of create\+Buffer that provide a valid \hyperlink{a00032}{Accelerator\+Buffer} instance modeling the hardware memory or bits being computed on. Upon creating an \hyperlink{a00032}{Accelerator\+Buffer}, derived \hyperlink{a00030}{Accelerator} implementations must call the protected store\+Buffer method to store the \hyperlink{a00032}{Accelerator\+Buffer} for future reference by Compilers and clients of \hyperlink{a00030}{Accelerator}. 
...
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{a00030_aed88ab0d71b765f0b0f512684ccd4b55}{}\label{a00030_aed88ab0d71b765f0b0f512684ccd4b55}
Destructor 
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{a00030_aab5046e8d83ab390302e0f49533e95fc}{}\label{a00030_aab5046e8d83ab390302e0f49533e95fc}
...
Implemented in \hyperlink{a00252_ada3ceb986e51ab5aa721f2a08e083cd6}{xacc\+::quantum\+::\+Rigetti\+Accelerator}, and \hyperlink{a00278_a46445d77d4b8ad2689571d0db6604380}{xacc\+::quantum\+::\+Simple\+Accelerator}.
...
\item[{const int}]{size}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{a00030_a064a2dbd58338364115c260267806945}{}\label{a00030_a064a2dbd58338364115c260267806945}
...
Implemented in \hyperlink{a00252_a731551c94b1abef40d2cf032e8712df6}{xacc\+::quantum\+::\+Rigetti\+Accelerator}, and \hyperlink{a00278_adb9393692e9f484df241aa5d014030d1}{xacc\+::quantum\+::\+Simple\+Accelerator}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{a00030_a89b3f3e6294f228abf03a410b0fb1674}{}\label{a00030_a89b3f3e6294f228abf03a410b0fb1674}
Execute the provided X\+A\+CC \hyperlink{a00167}{IR} \hyperlink{a00106}{Function} on the provided \hyperlink{a00032}{Accelerator\+Buffer}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{a00030_ab3820be326e28a553fed1a824f4d41d0}{}\label{a00030_ab3820be326e28a553fed1a824f4d41d0}
Return the stored \hyperlink{a00032}{Accelerator\+Buffer} with the provided string id.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{a00030_ad6e4a642dcb24e552675bcbeff1e1b04}{}\label{a00030_ad6e4a642dcb24e552675bcbeff1e1b04}
Return any \hyperlink{a00167}{IR} Transformations that must be applied to ensure the compiled \hyperlink{a00167}{IR} is amenable to execution on this \hyperlink{a00030}{Accelerator}. \begin{DoxyReturn}{Returns}

\end{DoxyReturn}


Implemented in \hyperlink{a00252_a443683a1dfb000603c640b2ee303cf66}{xacc\+::quantum\+::\+Rigetti\+Accelerator}, and \hyperlink{a00278_afc49c9e7973ba6c6ff9761c36198323d}{xacc\+::quantum\+::\+Simple\+Accelerator}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{a00030_a98c9eda6b54367c75667ecfbbf167979}{}\label{a00030_a98c9eda6b54367c75667ecfbbf167979}
...
Reimplemented in \hyperlink{a00252_a9ee9e62aecbccf193894ca3388676f9f}{xacc\+::quantum\+::\+Rigetti\+Accelerator}.
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{a00030_aaffc3e4bb9880eb5041b1b58ee4c2665}{}\label{a00030_aaffc3e4bb9880eb5041b1b58ee4c2665}
Return the type of this \hyperlink{a00030}{Accelerator}.

\begin{DoxyReturn}{Returns}
type The \hyperlink{a00030}{Accelerator} type -\/ Gate or A\+QC Q\+PU, or N\+PU 
\end{DoxyReturn}


Implemented in \hyperlink{a00252_aab0d4674da5273d55407b9ab77cde890}{xacc\+::quantum\+::\+Rigetti\+Accelerator}, and \hyperlink{a00278_ad76eeb0bbd7de21aad5bd20d20970a98}{xacc\+::quantum\+::\+Simple\+Accelerator}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{a00030_ae51584850faeec77299058383977ddeb}{}\label{a00030_ae51584850faeec77299058383977ddeb}
...
Implemented in \hyperlink{a00252_a61352c07062597aad2393fbeed4cc025}{xacc\+::quantum\+::\+Rigetti\+Accelerator}, and \hyperlink{a00278_a60b9db2d6aed235857c45413a070338e}{xacc\+::quantum\+::\+Simple\+Accelerator}.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [protected]}}\hypertarget{a00030_ac3e781f42ec25e460174d4c41ea26b94}{}\label{a00030_ac3e781f42ec25e460174d4c41ea26b94}
This protected method is to be used by derived Accelerators to store any created \hyperlink{a00032}{Accelerator\+Buffer}.
