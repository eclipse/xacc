...
public:
  std::map<std::string, InstructionParameter> properties;
};
...
public:
  ...
  void
  addVertex(std::map<std::string, InstructionParameter> &&properties) override;
  void
  addVertex(std::map<std::string, InstructionParameter> &properties) override;

  void setVertexProperties(
      const int index,
      std::map<std::string, InstructionParameter> &&properties) override;
  void
